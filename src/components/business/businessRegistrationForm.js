...
import * as styles from "../business/businessRegistrationForm.module.scss"




const BusinessRegstrationForm = () => {
    ...
    fetch("/", {
      ...
      .then(() => navigate("/business-payment"))
    ...
    return (
        ...
        <>
        <h1>Business Vendor Registration</h1>
    ...
    export default BusinessRegstrationForm