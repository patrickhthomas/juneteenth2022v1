...
const LandingPage = () => {
    ...
    return (
        ...
        <div className={styles.container}>
            ...
            <StaticImage className={styles.image} src="../images/vancouver.jpeg" alt="downtown vancouver, wasthington" />
            ...
            <StaticImage className={styles.image} src="../images/corpuschristi.jpeg" alt="Six women in a carriage decorated with flowers. Old sepia toned photograph from 1913" />
            ...
            <StaticImage className={styles.image} src="../images/vendor1.jpeg" alt="A woman in a white t shirt picking up an iced coffee from an outdoor coffee vendor" />
            <StaticImage className={styles.image__karen} src="../images/karen1.jpeg" alt="Karen Morrisson Of Odyssey World Internation Education Services speaking at a fundraising event in Camas, Washington" />
